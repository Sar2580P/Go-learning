...
// 🌟 below are the request and response for 2 services: create-order , get-order
...
const file_orders_proto_rawDesc = "" +
	...
	"\tGetOrders\x12\x11.GetOrdersRequest\x1a\x11.GetOrderResponse\"\x00B*Z(grpc_kitchen_microservices/common/ordersb\x06proto3"
